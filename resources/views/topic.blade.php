			...
			<div class="px-8 py-2 w-full">
				...
				<div class="min-w-full mt-16">
					...
					<textarea type="text" placeholder="Yorumunuz" rows="8	"
						class="block border-none placeholder:text-gray-300 text-sm ring-gray-300 focus:ring-blue-300 ring-1 ring-inset rounded-md bg-white py-3 px-4 w-6/12 focus:outline-none mt-2"
						id="entry" required></textarea>

				</div>
				<input id="createEntrySubmit" type="button"
					class="block border-none text-white text-sm bg-indigo-500 py-3 px-4 w-100 rounded-md focus:outline-none w-32 mt-8 cursor-pointer"
					value="Yorum bırak">
			</div>
			<x-ads />
		</div>
